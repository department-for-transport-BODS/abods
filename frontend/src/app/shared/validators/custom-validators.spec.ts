...
describe("CustomValidators", () => {
  describe("CustomValidators.requiredNoWhitespace", () => {
    ...
    it("should return error if value is null", () => {
      ...
      expect(CustomValidators.requiredNoWhitespace(control)).toEqual(
        expectedError,
      );
    });
  ...
  describe("CustomValidators.dateWithinRange", () => {
    ...
    beforeEach(() => {
      control = new FormControl(
        null,
        CustomValidators.dateWithinRange(Interval.fromISO("P6M/2022-09-01")),
      );
    });
    ...
    it("should fail gracefully if the maximum date is not valid", () => {
      control.validator = CustomValidators.dateWithinRange(
        Interval.fromISO("not a valid interval"),
      );
      control.setValue(DateTime.fromISO("2023-01-01"));
