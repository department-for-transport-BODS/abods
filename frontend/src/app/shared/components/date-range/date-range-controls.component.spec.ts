...
describe("DateRangeControlsComponent", () => {
  ...
  beforeEach(() => {
    ...
    spectator = createComponent(
      "<app-date-range-controls></app-date-range-controls>",
    );
  ...
  it("should allow valid dates to be applied", () => {
    ...
    spectator.click(
      byText("4", {
        selector:
          ".date-range-controls__calendar:nth-child(1) .date-range-controls__day",
      }),
    );
...
describe("DateRangeControlsComponent (Angular)", () => {
  ...
  it("should handle dates manually typed in the wrong order DRA-931", () => {
    ...
    const closeControls = spyOn(
      fixture.componentInstance.closeControls,
      "emit",
    );
