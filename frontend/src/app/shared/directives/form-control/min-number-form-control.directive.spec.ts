...
describe("MinNumberFormControlDirective", () => {
  ...
  it("should accept value greater than or equal to minNumber", waitForAsync(() => {
  ...
  it("should update value to minNunber if input is less than minNumber", waitForAsync(() => {
    const el = fixture.nativeElement.querySelector("input");
    el.value = 9;
    el.dispatchEvent(new Event("input"));
    fixture.detectChanges();
