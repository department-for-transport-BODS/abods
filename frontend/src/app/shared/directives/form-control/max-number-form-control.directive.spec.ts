...
describe("MaxNumberFormControlDirective", () => {
  ...
  it("should accept value less than or equal to maxNumber", waitForAsync(() => {
  ...
  it("should update value to maxNumber if input is greater than maxNumber", waitForAsync(() => {
    const el = fixture.nativeElement.querySelector("input");
    el.value = 11;
    el.dispatchEvent(new Event("input"));
    fixture.detectChanges();
