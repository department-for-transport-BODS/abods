...
describe("OperatorService", () => {
  ...
  it("should query operators", waitForAsync(() => {
  ...
  it("should filter operators by name", waitForAsync(() => {
  ...
  it("should return all operators if term is empty string", waitForAsync(() => {
  ...
  it("should filter operators with ampersand in name", waitForAsync(() => {
