...
export class StopSearchListComponent {
  ...
  @Output() mouseOver: EventEmitter<Feature<Point, Stop>> = new EventEmitter<
    Feature<Point, Stop>
  >();
  @Output() mouseLeave: EventEmitter<Feature<Point, Stop>> = new EventEmitter<
    Feature<Point, Stop>
  >();
  @Output() addStop: EventEmitter<Feature<Point, Stop>> = new EventEmitter<
    Feature<Point, Stop>
  >();
