...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () =>
      import("./feed-monitoring/feed-monitoring.module").then(
        (mod) => mod.FeedMonitoringModule,
      ),
  },
  {
    path: "dashboard",
  ...
  },
  {
    path: "on-time",
    loadChildren: () =>
      import("./on-time/on-time.module").then((mod) => mod.OnTimeModule),
  },
  {
    path: "corridors",
    loadChildren: () =>
      import("./corridors/corridors.module").then((mod) => mod.CorridorsModule),
  },
  {
    path: "geography",
