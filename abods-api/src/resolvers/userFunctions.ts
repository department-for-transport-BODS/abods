...
export const getSession = async (sessionId: string, db: Context) : Promise<SessionUser | null> =>  {
...
const updateUserAlert: MutationResolvers['updateUserAlert'] = async (_, args, context) => {
  try {
    const user = requireUserSession(context)
