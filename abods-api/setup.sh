...
echo "DATABASE_URL=postgresql://abods_proxy_rw:${DB_PASSWORD//@/%40}@localhost:15432/abods?schema=public&connection_limit=50&gssencmode=disable&sslmode=require&ssl=true" >> .env
echo "SUPPORT_USER_EMAIL_DOMAINS=kainos.com, arup.com, kpmg.co.uk" >> .env
