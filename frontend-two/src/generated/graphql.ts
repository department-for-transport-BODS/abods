...
export type CorridorsListQuery = {
  corridor: {
    ...
    corridorList: Array<{
      ...
      id: number;
      name: string;
      stops: Array<{ __typename?: "StopInfoType"; stopId: string }>;
    }>;
  } | null;
};
    ...
    getCorridor: {
      ...
      stops: Array<{
        ...
        stopLocality: {
          ...
          localityName: string | null;
          localityAreaId: string | null;
          localityAreaName: string | null;
        };
      }>;
    } | null;
  } | null;
...
export type CorridorStatsQuery = {
  corridor: {
    ...
    stats: {
      ...
      transitTimeTimeOfDayStats: Array<{
      ...
      transitTimeDayOfWeekStats: Array<{
      ...
      transitTimePerServiceStats: Array<{
...
export type DashboardOperatorListQueryVariables = Exact<{
  [key: string]: never;
}>;

export type DashboardOperatorListQuery = {
  operatorsFeedMonitoring: Array<{
    __typename?: "OperatorFeedMonitoring";
    name: string;
    nocCode: string;
    operatorId: string;
...
export type DashboadEmbeddedUrlQuery = {
  embeddedUrl: {
...
export type UserOrganisationsQuery = {
  userOrgs: Array<{ __typename?: "Organisation"; name: string; id: number }>;
};
...
export type OrgOperatorListQuery = {
  operators: Array<{
...
export type DistancesListQuery = {
  distances: Array<{
    __typename?: "Distance";
    operatorId: string;
    operatorName: string;
...
export type DistancesDropdownInputQuery = {
  distancesDropdowns: {
...
export type EventFragment = {
  ...
  timestamp: string;
  type: string;
  data: { __typename?: "EventData"; message: string };
};
...
export type ServicePatternDistanceGeomQuery = {
  ...
  definitions: [
    {
      ...
      name: { kind: "Name", value: "OperatorDashboard" },
      typeCondition: {
        kind: "NamedType",
        name: { kind: "Name", value: "OperatorFeedMonitoring" },
      },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          { kind: "Field", name: { kind: "Name", value: "name" } },
          { kind: "Field", name: { kind: "Name", value: "nocCode" } },
          { kind: "Field", name: { kind: "Name", value: "operatorId" } },
          {
            ...
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "feedStatus" } },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "liveStats" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "feedErrors" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "feedAlerts" },
                      },
                    ],
                  },
                },
...
} as unknown as DocumentNode<OperatorDashboardFragment, unknown>;
...
export const BasicOperatorFragmentDoc = {
  ...
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "BasicOperator" },
      typeCondition: {
        kind: "NamedType",
        name: { kind: "Name", value: "OperatorFeedMonitoring" },
      },
          ...
          { kind: "Field", name: { kind: "Name", value: "operatorId" } },
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "lastOutage" } },
                {
                  kind: "Field",
...
} as unknown as DocumentNode<BasicOperatorFragment, unknown>;
export const VehicleStatFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "VehicleStat" },
      typeCondition: {
        kind: "NamedType",
        name: { kind: "Name", value: "VehicleStatsType" },
      },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
...
} as unknown as DocumentNode<VehicleStatFragment, unknown>;
export const OperatorLiveStatusFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
                ...
                },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "currentVehicles" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "expectedVehicles" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "last24Hours" },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            {
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "last20Minutes" },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            {
...
} as unknown as DocumentNode<OperatorLiveStatusFragment, unknown>;
export const OperatorFeedHistoryFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "OperatorFeedHistory" },
      typeCondition: {
        kind: "NamedType",
        name: { kind: "Name", value: "OperatorFeedMonitoring" },
      },
          ...
          { kind: "Field", name: { kind: "Name", value: "operatorId" } },
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: "Field",
                  name: { kind: "Name", value: "historicalStats" },
                  arguments: [
                    {
                      kind: "Argument",
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "vehicleStats" },
                  arguments: [
                    {
                      kind: "Argument",
...
} as unknown as DocumentNode<OperatorFeedHistoryFragment, unknown>;
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "unlockAt" } },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "failedAttempts" },
                },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "canViewDistances" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "serviceMonitoringEmbedUrl" },
                },
...
export const CorridorsStopSearchDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "corridorsStopSearch" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "AddFirstStopInputType" },
            },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "corridor" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                {
                  kind: "Field",
                  name: { kind: "Name", value: "addFirstStop" },
                  arguments: [
                    {
                      kind: "Argument",
                      name: { kind: "Name", value: "inputs" },
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "stopId" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "stopName" },
                      },
                      { kind: "Field", name: { kind: "Name", value: "lat" } },
                      { kind: "Field", name: { kind: "Name", value: "lon" } },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "localityName" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "adminAreaId" },
                      },
                      {
                        kind: "Field",
...
>;
export const CorridorsSubsequentStopsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "corridorsSubsequentStops" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
>;
export const CorridorsListDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "corridorsList" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: "Field",
                  name: { kind: "Name", value: "corridorList" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
...
} as unknown as DocumentNode<CorridorsListQuery, CorridorsListQueryVariables>;
export const GetCorridorDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getCorridor" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "corridorId" },
          },
          type: {
            kind: "NonNullType",
                      ...
                      { kind: "Field", name: { kind: "Name", value: "name" } },
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "stopLocation" },
                              selectionSet: {
                                kind: "SelectionSet",
                                selections: [
                                  {
                            ...
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "stopLocality" },
                              selectionSet: {
                                kind: "SelectionSet",
                                selections: [
                                  {
                                    kind: "Field",
                                    name: { kind: "Name", value: "localityId" },
                                  },
                                  {
                                    kind: "Field",
                                    name: {
...
} as unknown as DocumentNode<GetCorridorQuery, GetCorridorQueryVariables>;
export const CorridorStatsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "corridorStats" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "CorridorStatsInputType" },
            },
          },
        },
      ],
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "summaryStats" },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "totalTransits" },
                            },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "numberOfServices" },
                            },
                            {
                              kind: "Field",
                              name: {
                                kind: "Name",
                                value: "averageTransitTime",
                              },
                            },
                            {
                              kind: "Field",
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "transitTimeStats" },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            {
                            ...
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "minTransitTime" },
                            },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "maxTransitTime" },
                            },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "avgTransitTime" },
                            },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "percentile25" },
                            },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "percentile75" },
                            },
                          ],
                        },
                      },
                      {
                        ...
                        name: {
                          kind: "Name",
                          value: "transitTimeTimeOfDayStats",
                        },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                      ...
                      },
                      {
                        ...
                        name: {
                          kind: "Name",
                          value: "transitTimeDayOfWeekStats",
                        },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                      ...
                      },
                      {
                        ...
                        name: {
                          kind: "Name",
                          value: "transitTimePerServiceStats",
                        },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            ...
                            },
                            {
                              ...
                              name: {
                                kind: "Name",
                                value: "servicePatternName",
                              },
                            },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "noc" },
                            },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "operatorName" },
                            },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "totalTransitTime" },
                            },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "recordedTransits" },
                            },
                            {
                              kind: "Field",
                              name: {
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "transitTimeHistogram" },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            {
                            ...
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "hist" },
                              selectionSet: {
                                kind: "SelectionSet",
                                selections: [
                                  {
                                    kind: "Field",
                                    name: { kind: "Name", value: "bin" },
                                  },
                                  {
                                    kind: "Field",
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "serviceLinks" },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "fromStop" },
                            },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "toStop" },
                            },
                            {
                              kind: "Field",
                            ...
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "routeValidity" },
                            },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "linkRoute" },
                            },
                          ],
                        },
                      },
...
} as unknown as DocumentNode<CorridorStatsQuery, CorridorStatsQueryVariables>;
export const CreateCorridorDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "createCorridor" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
  ...
  CreateCorridorMutationVariables
>;
export const DeleteCorridorDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "deleteCorridor" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  DeleteCorridorMutationVariables
>;
export const UpdateCorridorDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "updateCorridor" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "CorridorUpdateInputType" },
            },
          },
        },
      ],
  ...
  UpdateCorridorMutationVariables
>;
export const DashboardOperatorListDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "dashboardOperatorList" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "operatorsFeedMonitoring" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "dashboardOperatorVehicleCountsList" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "dashboardVehicles" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "operatorId" },
...
>;
export const DashboardPerformanceStatsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "dashboardPerformanceStats" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "PerformanceInputType" },
            },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "onTimePerformance" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                {
                  kind: "Field",
                  name: { kind: "Name", value: "punctualityOverview" },
                  arguments: [
                    {
                      kind: "Argument",
                      name: { kind: "Name", value: "inputs" },
...
>;
export const DashboardServiceRankingDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "dashboardServiceRanking" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "ServicePerformanceInputType" },
            },
          },
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "trendFrom" },
          },
          type: {
            kind: "NonNullType",
            type: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: "Field",
                  name: { kind: "Name", value: "servicePunctuality" },
                  arguments: [
                    {
                      kind: "Argument",
                      name: { kind: "Name", value: "inputs" },
                      ...
                      },
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "serviceNumber" },
                            },
                          ],
                        },
                      },
                      ...
                      { kind: "Field", name: { kind: "Name", value: "late" } },
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "early" },
                            },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "late" },
                            },
                          ],
                        },
                      },
...
export const DashboadEmbeddedUrlDocument = {
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "embeddedUrl" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
  ...
  DashboadEmbeddedUrlQueryVariables
>;
export const UserOrganisationsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
  ...
  UserOrganisationsQueryVariables
>;
export const OrgOperatorListDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "orgOperatorList" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  OrgOperatorListQuery,
  OrgOperatorListQueryVariables
>;
export const DistancesListDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "distancesList" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "DistancesFilterInput" },
            },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "distances" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "filterBy" },
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "lineName" } },
                { kind: "Field", name: { kind: "Name", value: "serviceName" } },
                { kind: "Field", name: { kind: "Name", value: "distance" } },
                { kind: "Field", name: { kind: "Name", value: "avlDistance" } },
              ],
            },
          },
        ],
...
} as unknown as DocumentNode<DistancesListQuery, DistancesListQueryVariables>;
export const DistancesDropdownInputDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "distancesDropdownInput" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
  ...
  DistancesDropdownInputQueryVariables
>;
export const AdminOrgListDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "adminOrgList" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "adminOrgMap" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "adminAreaId" } },
                { kind: "Field", name: { kind: "Name", value: "adminName" } },
                { kind: "Field", name: { kind: "Name", value: "operatorId" } },
...
} as unknown as DocumentNode<AdminOrgListQuery, AdminOrgListQueryVariables>;
...
export const EventStatsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "eventStats" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
} as unknown as DocumentNode<EventStatsQuery, EventStatsQueryVariables>;
export const FeedMonitoringListDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
  ...
  FeedMonitoringListQueryVariables
>;
export const OperatorSparklineStatsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
...
export const OperatorLiveStatusDocument = {
  ...
  OperatorLiveStatusQueryVariables
>;
export const OperatorHistoricStatsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "operatorHistoricStats" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
export const HeadwayTimeSeriesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "headwayTimeSeries" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "HeadwayInputType" },
            },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "headwayMetrics" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                {
  ...
  HeadwayTimeSeriesQueryVariables
>;
export const HeadwayOverviewDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
  ...
  HeadwayOverviewQueryVariables
>;
export const HeadwayFrequentServicesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: "Field",
                  name: { kind: "Name", value: "frequentServices" },
                  arguments: [
                    {
                      kind: "Argument",
                      name: { kind: "Name", value: "operatorId" },
  ...
  HeadwayFrequentServicesQueryVariables
>;
export const HeadwayFrequentServiceInfoDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "headwayFrequentServiceInfo" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "FrequentServiceInfoInputType" },
            },
          },
        },
      ],
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: "Field",
                  name: { kind: "Name", value: "frequentServiceInfo" },
                  arguments: [
                    {
                      kind: "Argument",
                      name: { kind: "Name", value: "inputs" },
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "numHours" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "totalHours" },
                      },
                    ],
                  },
                },
  ...
  HeadwayFrequentServiceInfoQueryVariables
>;
export const OnTimeDelayFrequencyDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: "Field",
                  name: { kind: "Name", value: "delayFrequency" },
                  arguments: [
                    {
                      kind: "Argument",
                      name: { kind: "Name", value: "inputs" },
...
>;
export const OnTimeTimeSeriesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "onTimeTimeSeries" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: "Field",
                  name: { kind: "Name", value: "punctualityTimeSeries" },
                  arguments: [
                    {
                      kind: "Argument",
                      name: { kind: "Name", value: "inputs" },
  ...
  OnTimeTimeSeriesQueryVariables
>;
export const OnTimeStatsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "onTimeStats" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "averageDeviation" },
                      },
                      {
                        kind: "Field",
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "averageDelay" },
                      },
                    ],
                  },
                },
...
} as unknown as DocumentNode<OnTimeStatsQuery, OnTimeStatsQueryVariables>;
export const OnTimePunctualityTimeOfDayDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "onTimePunctualityTimeOfDay" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  OnTimePunctualityTimeOfDayQueryVariables
>;
export const OnTimePunctualityDayOfWeekDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: "Field",
                  name: { kind: "Name", value: "punctualityDayOfWeek" },
                  arguments: [
                    {
                      kind: "Argument",
                      name: { kind: "Name", value: "inputs" },
...
>;
export const OnTimeServicePerformanceListDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "onTimeServicePerformanceList" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: "Field",
                  name: { kind: "Name", value: "servicePerformance" },
                  arguments: [
                    {
                      kind: "Argument",
                      name: { kind: "Name", value: "inputs" },
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "countDelayed" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "scheduledDepartures" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "actualDepartures" },
                      },
                      {
                        kind: "Field",
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "onTimeInSeconds" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "earlyInSeconds" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "lateInSeconds" },
                      },
                    ],
                  },
                },
  ...
  OnTimeServicePerformanceListQueryVariables
>;
export const OnTimeStopPerformanceListDocument = {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: "Field",
                  name: { kind: "Name", value: "stopPerformance" },
                  arguments: [
                    {
                      kind: "Argument",
                      name: { kind: "Name", value: "inputs" },
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "timingPoint" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "direction" },
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "averageActual" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "onTimeInSeconds" },
  ...
  OnTimeStopPerformanceListQueryVariables
>;
export const OnTimeOperatorPerformanceListDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "onTimeOperatorPerformanceList" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: "Field",
                  name: { kind: "Name", value: "operatorPerformance" },
                  arguments: [
                    {
                      kind: "Argument",
                      name: { kind: "Name", value: "inputs" },
  ...
  OnTimeOperatorPerformanceListQueryVariables
>;
export const ServiceInfoDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "serviceInfo" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
} as unknown as DocumentNode<ServiceInfoQuery, ServiceInfoQueryVariables>;
export const TransitModelServicePatternStopsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "transitModelServicePatternStops" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "servicePatterns" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "operatorId" },
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: "Field",
                  name: { kind: "Name", value: "servicePatternId" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "stops" },
  ...
  TransitModelServicePatternStopsQueryVariables
>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "operatorList" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "adminAreaIds" },
                },
              ],
            },
          },
...
} as unknown as DocumentNode<OperatorListQuery, OperatorListQueryVariables>;
export const OperatorLinesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "operatorLines" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "inputDate" },
          },
          type: {
            kind: "NonNullType",
            type: {
...
} as unknown as DocumentNode<OperatorLinesQuery, OperatorLinesQueryVariables>;
export const StopAnalysisDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "stopAnalysis" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
        ...
        },
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "BoundingBoxInputType" },
            },
          },
        },
        {
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "dayOfWeekFlags" },
          },
          type: {
            kind: "NamedType",
            name: { kind: "Name", value: "DayOfWeekFlagsInputType" },
          },
        },
        {
          kind: "VariableDefinition",
        ...
        selections: [
          {
            ...
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "atcoCode" } },
                { kind: "Field", name: { kind: "Name", value: "stopName" } },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "localityName" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "adminAreaName" },
                },
                { kind: "Field", name: { kind: "Name", value: "timingPoint" } },
                { kind: "Field", name: { kind: "Name", value: "latitude" } },
                { kind: "Field", name: { kind: "Name", value: "longitude" } },
                { kind: "Field", name: { kind: "Name", value: "early" } },
                { kind: "Field", name: { kind: "Name", value: "late" } },
                { kind: "Field", name: { kind: "Name", value: "onTime" } },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "scheduledDepartures" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "completedDepartures" },
                },
                { kind: "Field", name: { kind: "Name", value: "totalDelay" } },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "onTimeInSeconds" },
                },
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "averageScheduledTimingPoint" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "averageActual" },
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "averageActualTimingPoint" },
                },
              ],
            },
          },
...
} as unknown as DocumentNode<StopAnalysisQuery, StopAnalysisQueryVariables>;
export const JourneyDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "journey" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "estimatedDepartureUtc" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "actualDepartureUtc" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "scheduledDepartureUtc" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "latitude" },
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "isTimingPoint" },
                      },
                      { kind: "Field", name: { kind: "Name", value: "otp" } },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "directionRef" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "incompleteReason" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "setDown" },
                      },
                    ],
                  },
                },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "vehicleRef" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "directionRef" },
...
} as unknown as DocumentNode<JourneyQuery, JourneyQueryVariables>;
export const JourneysDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "journeys" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "dateOfJourney" },
          },
          type: {
            kind: "NonNullType",
            type: {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "findJourneys" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "dateOfJourney" },
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "operatorNoc" } },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "directionRef" },
                },
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "vehicleJourneyId" },
                },
              ],
            },
          },
...
} as unknown as DocumentNode<JourneysQuery, JourneysQueryVariables>;
export const ServicePatternDistanceGeomDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "servicePatternDistanceGeom" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "getServicePatternDistanceGeom" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "vehicleJourneyId" },
            ...
            selectionSet: {
              ...
              selections: [
                { kind: "Field", name: { kind: "Name", value: "distance" } },
                { kind: "Field", name: { kind: "Name", value: "geom" } },
              ],
            },
          },
        ],
  ...
  ServicePatternDistanceGeomQueryVariables
>;
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "apiInfo" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "version" } },
                { kind: "Field", name: { kind: "Name", value: "buildNumber" } },
              ],
            },
          },
        ],
