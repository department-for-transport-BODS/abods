...
const COLORS = {
  lightBlue: "#5694ca",  // index 0 – actual bars
  blue: "#1d70b8",       // index 1 – hatch pattern
  darkBlue: "#003078",   // index 2 – expected step line
  black: "#0b0c0c",      // index 5 – cursor / tooltip border
  legendaryGrey: "#626A6E", // index 6 – axis labels
};
...
const LiveVehicleStats = ({ data, granularity, label, xAxisMin, xAxisMax }: {  data: VehicleStat[], granularity: Granularity, label: string, xAxisMin?: Date | number, xAxisMax?: Date | number }) => {
