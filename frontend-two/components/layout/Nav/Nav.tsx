...
export const Nav = () => {
  ...
  return (
    <nav
      id="navigation"
      className={clsx(styles.nav, isOpen && styles.open)}
      aria-label="Primary"
    >
      <div className={styles.block} id="nav">
            ...
            return (
              <li key={item.href} className={styles.item}>
                <Link
                  href={item.href}
                  onClick={close}
                  className={clsx(styles.link, isActive && styles.linkCurrent)}
                >
                  {item.label}
                </Link>
              </li>
      ...
      <div className={styles.menuBottom}>
        <button
          className={clsx(styles.menuBottomActionItem, "button-link")}
